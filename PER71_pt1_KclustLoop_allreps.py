...
totalcountsdf.loc[totalcountsdf['signature'] == '.', 'signature'] = '0'
...
for r in reps:
    ...
    for sig in sigs:
        ...
        plt.xlabel('Fraction of Total Signatures, IPTG (%)',fontsize=20)
        plt.ylabel('Fraction of Total Signatures, DOX (%)',fontsize=20)
