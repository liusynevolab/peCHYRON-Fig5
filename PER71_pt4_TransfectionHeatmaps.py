...
dateofint = 'YYYYMMDD' # for choosing the specific .csv that was generated from the ExpBigram_AllEpoch.py script
...
for title, sample_data in zip(['RPUI', 'URSP'], exp_bigrams.groupby('SampleID')):
    ...
    plt.figure(figsize=(9, 8))  # Set the size of the figure to be square
