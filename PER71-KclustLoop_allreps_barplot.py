...
for r in reps:
    ...
    for sig in sigs:
        ...
        ax = sns.barplot(data=currrep, x='Trt', y=sig, color='#47889D', zorder=1, 
                         order = currrep.sort_values(sig)['Trt'], palette='mako',
        ...
        plt.savefig(dateofint+"_PER71-"+sig+"plot_Cluster" + r + ".pdf", dpi=1200, bbox_inches='tight')
        plt.savefig(dateofint+"_PER71-"+sig+"plot_Cluster" +r+".png", dpi=1200, bbox_inches='tight')
        plt.clf()
