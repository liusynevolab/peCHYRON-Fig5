...
dateofint = 'YYYYMMDD' # for choosing the specific .csv that was generated from the PER71-ExpBigram.py script
...
# Aggregate dataframe rows
df_merged2 = klusterdf.groupby('SampleID').first().reset_index()
df_merged2 = df_merged2.merge(idkey, how = 'left',on = ['SampleID'])

# Save aggregated cluster data to csv
klusterdf.to_csv(dateofint+'_PER71-AllColumns_ClusteredDataTable.csv',encoding='utf-8')
